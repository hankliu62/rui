...
const baseConfig = {
  ...
  resolve: {
    ...
    extensions: ['.js', '.jsx'],
    alias: {
      systemConfig: process.env.NODE_ENV === 'prod' ? path.resolve(systemConfigPath, 'systemConfig.prod.js') : path.resolve(systemConfigPath, 'systemConfig.dev.js'),
      '@': path.resolve(pathsUtils.client())
    }
  },
  module: {
    rules: [
